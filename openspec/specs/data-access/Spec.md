...
Sistem HARUS menyediakan mekanisme backup dan recovery data.

#### Scenario: Data Backup & Recovery
- GIVEN kebutuhan backup data
- WHEN scheduled backup job run
- THEN sistem backup PostgreSQL database harian
- AND backup disimpan di secure storage (S3 dengan encryption)
- AND retention policy: 7 daily backups, 4 weekly backups
- AND recovery procedure terdokumentasi