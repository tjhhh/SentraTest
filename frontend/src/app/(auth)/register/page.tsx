...
import { Mail, Lock, User, Search, ArrowRight, ShieldCheck } from 'lucide-react';
      ...
      <div className="w-full max-w-md relative z-10 animate-in fade-in zoom-in duration-500">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl">
          <div className="space-y-5">
            ...
            <button className="w-full bg-indigo-600 text-white font-bold py-3 rounded-xl hover:bg-indigo-700 transition-all flex items-center justify-center gap-2 group shadow-lg shadow-indigo-900/50">
              Create Account
